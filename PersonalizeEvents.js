...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.PutEvents=function(svc,msg,cb){
			...
			copyArg(n,"trackingId",params,undefined,false); 
			copyArg(n,"sessionId",params,undefined,false); 
			copyArg(n,"eventList",params,undefined,false); 
			
			copyArg(msg,"trackingId",params,undefined,false); 
			copyArg(msg,"userId",params,undefined,false); 
			copyArg(msg,"sessionId",params,undefined,false); 
			copyArg(msg,"eventList",params,undefined,false); 
