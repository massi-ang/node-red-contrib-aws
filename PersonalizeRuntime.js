...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.GetPersonalizedRanking=function(svc,msg,cb){
			...
			copyArg(n,"inputList",params,undefined,false); 
			copyArg(n,"userId",params,undefined,false); 
			
			copyArg(msg,"campaignArn",params,undefined,false); 
			copyArg(msg,"inputList",params,undefined,false); 
			copyArg(msg,"userId",params,undefined,false); 
			copyArg(msg,"context",params,undefined,true); 
			copyArg(msg,"filterArn",params,undefined,false); 
			copyArg(msg,"filterValues",params,undefined,true); 
		...
		service.GetRecommendations=function(svc,msg,cb){
			...
			copyArg(msg,"campaignArn",params,undefined,false); 
			copyArg(msg,"itemId",params,undefined,false); 
			copyArg(msg,"userId",params,undefined,false); 
