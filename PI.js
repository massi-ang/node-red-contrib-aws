...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.DescribeDimensionKeys=function(svc,msg,cb){
			...
			copyArg(n,"ServiceType",params,undefined,false); 
			...
			copyArg(n,"GroupBy",params,undefined,true); 
			...
			copyArg(msg,"PeriodInSeconds",params,undefined,false); 
			copyArg(msg,"GroupBy",params,undefined,true); 
			copyArg(msg,"PartitionBy",params,undefined,true); 
		...
		service.GetDimensionKeyDetails=function(svc,msg,cb){
			...
			copyArg(n,"ServiceType",params,undefined,false); 
			copyArg(n,"Identifier",params,undefined,false); 
			copyArg(n,"Group",params,undefined,false); 
			copyArg(n,"GroupIdentifier",params,undefined,false); 
			
			copyArg(msg,"ServiceType",params,undefined,false); 
			copyArg(msg,"Identifier",params,undefined,false); 
			copyArg(msg,"Group",params,undefined,false); 
			copyArg(msg,"GroupIdentifier",params,undefined,false); 
			copyArg(msg,"RequestedDimensions",params,undefined,false); 
		...
		service.GetResourceMetrics=function(svc,msg,cb){
			...
			copyArg(n,"ServiceType",params,undefined,false); 
			copyArg(n,"Identifier",params,undefined,false); 
			copyArg(n,"MetricQueries",params,undefined,false); 
			copyArg(n,"StartTime",params,undefined,false); 
			copyArg(n,"EndTime",params,undefined,false); 
			
			copyArg(msg,"ServiceType",params,undefined,false); 
			copyArg(msg,"Identifier",params,undefined,false); 
			copyArg(msg,"MetricQueries",params,undefined,false); 
			copyArg(msg,"StartTime",params,undefined,false); 
			copyArg(msg,"EndTime",params,undefined,false); 
			copyArg(msg,"PeriodInSeconds",params,undefined,false); 
			copyArg(msg,"MaxResults",params,undefined,false); 
