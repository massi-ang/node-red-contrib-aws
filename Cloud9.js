...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.CreateEnvironmentEC2=function(svc,msg,cb){
			...
			copyArg(msg,"automaticStopTimeMinutes",params,undefined,false); 
			copyArg(msg,"ownerArn",params,undefined,false); 
		...
		service.CreateEnvironmentMembership=function(svc,msg,cb){
			...
			copyArg(n,"permissions",params,undefined,false); 
			
			copyArg(msg,"environmentId",params,undefined,false); 
			copyArg(msg,"userArn",params,undefined,false); 
			copyArg(msg,"permissions",params,undefined,false); 
		...
		service.DescribeEnvironments=function(svc,msg,cb){
			...
			copyArg(n,"environmentIds",params,undefined,false); 
		...
		service.UpdateEnvironment=function(svc,msg,cb){
			...
			copyArg(msg,"name",params,undefined,false); 
			copyArg(msg,"description",params,undefined,true); 
			copyArg(msg,"managedCredentialsAction",params,undefined,false); 
