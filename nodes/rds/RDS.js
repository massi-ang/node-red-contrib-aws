...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		var service={};
			...
			copyArgs(Boolean(n),"UseEarliestTimeOnPointInTimeUnavailable",params,undefined,false); 
			...
			copyArgs(Boolean(n),"EnableHttpEndpoint",params,undefined,false); 
			...
			copyArgs(Boolean(n),"EnableGlobalWriteForwarding",params,undefined,false); 
			copyArgs(n,"SourceRegion",params,undefined,false); 
			...
			copyArgs(Number(n),"PerformanceInsightsRetentionPeriod",params,undefined,false); 
			copyArgs(n,"EnableCloudwatchLogsExports",params,undefined,true); 
			copyArgs(n,"ProcessorFeatures",params,undefined,true); 
			copyArgs(Boolean(n),"DeletionProtection",params,undefined,false); 
			copyArgs(Number(n),"MaxAllocatedStorage",params,undefined,false); 
			copyArgs(Boolean(n),"EnableCustomerOwnedIp",params,undefined,false); 
			...
			copyArgs(n,"EnableCloudwatchLogsExports",params,undefined,true); 
			copyArgs(n,"ProcessorFeatures",params,undefined,true); 
			copyArgs(Boolean(n),"UseDefaultProcessorFeatures",params,undefined,false); 
			copyArgs(Boolean(n),"DeletionProtection",params,undefined,false); 
			copyArgs(n,"Domain",params,undefined,false); 
			copyArgs(n,"DomainIAMRoleName",params,undefined,false); 
			...
			copyArgs(n,"VpcSubnetIds",params,undefined,true); 
			copyArgs(n,"VpcSecurityGroupIds",params,undefined,true); 
			copyArgs(Boolean(n),"RequireTLS",params,undefined,false); 
			copyArgs(Number(n),"IdleClientTimeout",params,undefined,false); 
			copyArgs(Boolean(n),"DebugLogging",params,undefined,false); 
			copyArgs(n,"Tags",params,undefined,true); 
			...
			copyArgs(Boolean(n),"SkipFinalSnapshot",params,undefined,false); 
			copyArgs(n,"FinalDBSnapshotIdentifier",params,undefined,false); 
			copyArgs(Boolean(n),"DeleteAutomatedBackups",params,undefined,false); 
			...
			copyArgs(Boolean(n),"IncludeAll",params,undefined,false); 
			...
			copyArgs(n,"LogFileName",params,undefined,false); 
			copyArgs(n,"Marker",params,undefined,false); 
			copyArgs(Number(n),"NumberOfLines",params,undefined,false); 
			...
			copyArgs(n,"CertificateIdentifier",params,undefined,false); 
			copyArgs(Boolean(n),"RemoveCustomerOverride",params,undefined,false); 
			...
			copyArgs(Number(n),"SecondsBeforeTimeout",params,undefined,false); 
			...
			copyArgs(Boolean(n),"DeletionProtection",params,undefined,false); 
			copyArgs(Number(n),"MaxAllocatedStorage",params,undefined,false); 
			copyArgs(Boolean(n),"CertificateRotationRestart",params,undefined,false); 
			copyArgs(n,"ReplicaMode",params,undefined,false); 
			copyArgs(Boolean(n),"EnableCustomerOwnedIp",params,undefined,false); 
			...
			copyArgs(n,"ReservedDBInstancesOfferingId",params,undefined,false); 
			copyArgs(n,"ReservedDBInstanceId",params,undefined,false); 
			copyArgs(Number(n),"DBInstanceCount",params,undefined,false); 
			copyArgs(n,"Tags",params,undefined,true); 
			...
			copyArgs(n,"KmsKeyId",params,undefined,false); 
			copyArgs(Boolean(n),"ApplyImmediately",params,undefined,false); 
			copyArgs(Boolean(n),"EngineNativeAuditFieldsIncluded",params,undefined,false); 
