...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		var awsService = new AWS.IotDeviceAdvisor( { 'region': node.region } );
		
		node.on("input", function(msg, send, done) {
			var aService = msg.AWSConfig?new AWS.IotDeviceAdvisor(msg.AWSConfig) : awsService;
		...
		service.CreateSuiteDefinition=function(svc,msg,cb){
			...
			copyArgs(n,"suiteDefinitionConfiguration",params,undefined,true); 
			copyArgs(n,"tags",params,undefined,true); 
			
			copyArgs(msg,"suiteDefinitionConfiguration",params,undefined,true); 
		...
		service.GetSuiteDefinition=function(svc,msg,cb){
			...
			copyArgs(msg,"suiteDefinitionId",params,undefined,false); 
			copyArgs(msg,"suiteDefinitionVersion",params,undefined,false); 
		...
		service.GetSuiteRun=function(svc,msg,cb){
			...
			copyArgs(n,"suiteDefinitionId",params,undefined,false); 
			copyArgs(n,"suiteRunId",params,undefined,false); 
			
			copyArgs(n,"suiteDefinitionId",params,undefined,false); 
			copyArgs(n,"suiteRunId",params,undefined,false); 
			
			copyArgs(msg,"suiteDefinitionId",params,undefined,false); 
			copyArgs(msg,"suiteRunId",params,undefined,false); 
		...
		service.StartSuiteRun=function(svc,msg,cb){
			...
			copyArgs(n,"suiteDefinitionId",params,undefined,false); 
			copyArgs(n,"suiteDefinitionVersion",params,undefined,false); 
			copyArgs(n,"suiteRunConfiguration",params,undefined,true); 
			copyArgs(n,"tags",params,undefined,true); 
			
			copyArgs(msg,"suiteDefinitionId",params,undefined,false); 
			copyArgs(msg,"suiteDefinitionVersion",params,undefined,false); 
			copyArgs(msg,"suiteRunConfiguration",params,undefined,true); 
			copyArgs(msg,"tags",params,undefined,true); 
