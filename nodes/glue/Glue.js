...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		var service={};
			...
			copyArgs(n,"Names",params,undefined,false); 
			copyArgs(Boolean(n),"IncludeBlueprint",params,undefined,false); 
			copyArgs(Boolean(n),"IncludeParameterSpec",params,undefined,false); 
			...
			copyArgs(n,"Names",params,undefined,true); 
			copyArgs(Boolean(n),"IncludeGraph",params,undefined,false); 
			...
			copyArgs(Number(n),"NumberOfWorkers",params,undefined,false); 
			...
			copyArgs(Number(n),"AllocatedCapacity",params,undefined,false); 
			...
			copyArgs(n,"Actions",params,undefined,true); 
			copyArgs(n,"Description",params,undefined,false); 
			copyArgs(Boolean(n),"StartOnCreation",params,undefined,false); 
			copyArgs(n,"Tags",params,undefined,true); 
			...
			copyArgs(n,"Tags",params,undefined,true); 
			copyArgs(Number(n),"MaxConcurrentRuns",params,undefined,false); 
			...
			copyArgs(n,"CatalogId",params,undefined,false); 
			copyArgs(n,"Name",params,undefined,false); 
			copyArgs(Boolean(n),"HidePassword",params,undefined,false); 
			...
			copyArgs(n,"JobName",params,undefined,false); 
			copyArgs(n,"RunId",params,undefined,false); 
			copyArgs(Boolean(n),"PredecessorsIncluded",params,undefined,false); 
			...
			copyArgs(Number(n),"MaxResults",params,undefined,false); 
			copyArgs(Boolean(n),"ExcludeColumnSchema",params,undefined,false); 
			...
			copyArgs(n,"TransformId",params,undefined,false); 
			copyArgs(n,"InputS3Path",params,undefined,false); 
			copyArgs(Boolean(n),"ReplaceAllLabels",params,undefined,false); 
			...
			copyArgs(Boolean(n),"UpdateEtlLibraries",params,undefined,false); 
			...
			copyArgs(n,"DatabaseName",params,undefined,false); 
			copyArgs(n,"TableInput",params,undefined,true); 
			copyArgs(Boolean(n),"SkipArchive",params,undefined,false); 
