...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		var service={};
			...
			copyArgs(Number(n),"MaxUserDurationInSeconds",params,undefined,false); 
			copyArgs(Number(n),"DisconnectTimeoutInSeconds",params,undefined,false); 
			copyArgs(n,"Description",params,undefined,false); 
			copyArgs(n,"DisplayName",params,undefined,false); 
			copyArgs(Boolean(n),"EnableDefaultInternetAccess",params,undefined,false); 
			copyArgs(n,"DomainJoinInfo",params,undefined,true); 
			copyArgs(n,"Tags",params,undefined,true); 
			copyArgs(Number(n),"IdleDisconnectTimeoutInSeconds",params,undefined,false); 
			...
			copyArgs(Number(n),"MaxUserDurationInSeconds",params,undefined,false); 
			copyArgs(Number(n),"DisconnectTimeoutInSeconds",params,undefined,false); 
			copyArgs(Boolean(n),"DeleteVpcConfig",params,undefined,false); 
			copyArgs(n,"Description",params,undefined,false); 
			copyArgs(n,"DisplayName",params,undefined,false); 
			copyArgs(Boolean(n),"EnableDefaultInternetAccess",params,undefined,false); 
			copyArgs(n,"DomainJoinInfo",params,undefined,true); 
			...
			copyArgs(n,"Name",params,undefined,false); 
			copyArgs(n,"StorageConnectors",params,undefined,true); 
			copyArgs(Boolean(n),"DeleteStorageConnectors",params,undefined,false); 
			copyArgs(n,"RedirectURL",params,undefined,false); 
			copyArgs(n,"FeedbackURL",params,undefined,false); 
			copyArgs(n,"AttributesToDelete",params,undefined,false); 
			copyArgs(n,"UserSettings",params,undefined,true); 
