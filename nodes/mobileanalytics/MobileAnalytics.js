...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		var awsService = new AWS.MobileAnalytics( { 'region': node.region } );
		
		node.on("input", function(msg, send, done) {
			var aService = msg.AWSConfig?new AWS.MobileAnalytics(msg.AWSConfig) : awsService;
		...
		service.PutEvents=function(svc,msg,cb){
			...
			copyArgs(n,"events",params,undefined,false); 
			copyArgs(n,"clientContext",params,undefined,false); 
			copyArgs(n,"clientContextEncoding",params,undefined,false); 
			
			copyArgs(msg,"events",params,undefined,false); 
			copyArgs(msg,"clientContext",params,undefined,false); 
			copyArgs(msg,"clientContextEncoding",params,undefined,false); 
