...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		var service={};
			...
			copyArgs(n,"ChangeSetId",params,undefined,false); 
			
			copyArgs(n,"Catalog",params,undefined,false); 
			copyArgs(n,"ChangeSetId",params,undefined,false); 
			
			copyArgs(msg,"Catalog",params,undefined,false); 
			copyArgs(msg,"ChangeSetId",params,undefined,false); 
			...
			copyArgs(msg,"Catalog",params,undefined,false); 
			copyArgs(msg,"FilterList",params,undefined,true); 
			...
			copyArgs(n,"Catalog",params,undefined,false); 
			copyArgs(n,"ChangeSet",params,undefined,false); 
			...
			copyArgs(msg,"Catalog",params,undefined,false); 
			copyArgs(msg,"ChangeSet",params,undefined,false); 
