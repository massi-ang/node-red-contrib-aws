...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		var awsService = new AWS.S3Outposts( { 'region': node.region } );
		
		node.on("input", function(msg, send, done) {
			var aService = msg.AWSConfig?new AWS.S3Outposts(msg.AWSConfig) : awsService;
		...
		var service={};
			...
			copyArgs(n,"SecurityGroupId",params,undefined,false); 
			
			copyArgs(n,"OutpostId",params,undefined,false); 
			copyArgs(n,"SubnetId",params,undefined,false); 
			copyArgs(n,"SecurityGroupId",params,undefined,false); 
			copyArgs(n,"AccessType",params,undefined,false); 
			...
			copyArgs(msg,"SecurityGroupId",params,undefined,false); 
			copyArgs(msg,"AccessType",params,undefined,false); 
