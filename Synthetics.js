...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.CreateCanary=function(svc,msg,cb){
			...
			copyArg(n,"Code",params,undefined,true); 
			copyArg(n,"ArtifactS3Location",params,undefined,false); 
			copyArg(n,"ExecutionRoleArn",params,undefined,false); 
			copyArg(n,"Schedule",params,undefined,true); 
			copyArg(n,"RuntimeVersion",params,undefined,false); 
			
			copyArg(msg,"Name",params,undefined,false); 
			copyArg(msg,"Code",params,undefined,true); 
			copyArg(msg,"ArtifactS3Location",params,undefined,false); 
			copyArg(msg,"ExecutionRoleArn",params,undefined,false); 
			copyArg(msg,"Schedule",params,undefined,true); 
			copyArg(msg,"RunConfig",params,undefined,true); 
			copyArg(msg,"SuccessRetentionPeriodInDays",params,undefined,false); 
			copyArg(msg,"FailureRetentionPeriodInDays",params,undefined,false); 
			copyArg(msg,"RuntimeVersion",params,undefined,false); 
		...
		service.UpdateCanary=function(svc,msg,cb){
			...
			copyArg(msg,"FailureRetentionPeriodInDays",params,undefined,false); 
			copyArg(msg,"VpcConfig",params,undefined,true); 
			copyArg(msg,"VisualReference",params,undefined,false); 
