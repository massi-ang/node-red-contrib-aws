...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.DefineAnalysisScheme=function(svc,msg,cb){
			...
			copyArg(n,"DomainName",params,undefined,false); 
			copyArg(n,"AnalysisScheme",params,undefined,true); 
			
			copyArg(msg,"DomainName",params,undefined,false); 
			copyArg(msg,"AnalysisScheme",params,undefined,true); 
		...
		service.DefineIndexField=function(svc,msg,cb){
			...
			copyArg(n,"DomainName",params,undefined,false); 
			copyArg(n,"IndexField",params,undefined,true); 
			
			copyArg(msg,"DomainName",params,undefined,false); 
			copyArg(msg,"IndexField",params,undefined,true); 
		...
		service.DefineSuggester=function(svc,msg,cb){
			...
			copyArg(n,"DomainName",params,undefined,false); 
			copyArg(n,"Suggester",params,undefined,true); 
			
			copyArg(msg,"DomainName",params,undefined,false); 
			copyArg(msg,"Suggester",params,undefined,true); 
		...
		service.DeleteAnalysisScheme=function(svc,msg,cb){
			...
			copyArg(n,"DomainName",params,undefined,false); 
			copyArg(n,"AnalysisSchemeName",params,undefined,false); 
			
			copyArg(msg,"DomainName",params,undefined,false); 
			copyArg(msg,"AnalysisSchemeName",params,undefined,false); 
		...
		service.DeleteExpression=function(svc,msg,cb){
			...
			copyArg(n,"DomainName",params,undefined,false); 
			copyArg(n,"ExpressionName",params,undefined,false); 
			
			copyArg(msg,"DomainName",params,undefined,false); 
			copyArg(msg,"ExpressionName",params,undefined,false); 
		...
		service.DeleteIndexField=function(svc,msg,cb){
			...
			copyArg(n,"DomainName",params,undefined,false); 
			copyArg(n,"IndexFieldName",params,undefined,false); 
			
			copyArg(msg,"DomainName",params,undefined,false); 
			copyArg(msg,"IndexFieldName",params,undefined,false); 
		...
		service.DeleteSuggester=function(svc,msg,cb){
			...
			copyArg(n,"DomainName",params,undefined,false); 
			copyArg(n,"SuggesterName",params,undefined,false); 
			
			copyArg(msg,"DomainName",params,undefined,false); 
			copyArg(msg,"SuggesterName",params,undefined,false); 
		...
		service.DescribeAnalysisSchemes=function(svc,msg,cb){
			...
			copyArg(msg,"DomainName",params,undefined,false); 
			copyArg(msg,"AnalysisSchemeNames",params,undefined,true); 
		...
		service.DescribeExpressions=function(svc,msg,cb){
			...
			copyArg(msg,"DomainName",params,undefined,false); 
			copyArg(msg,"ExpressionNames",params,undefined,true); 
			copyArg(msg,"Deployed",params,undefined,false); 
		...
		service.DescribeIndexFields=function(svc,msg,cb){
			...
			copyArg(msg,"DomainName",params,undefined,false); 
			copyArg(msg,"FieldNames",params,undefined,false); 
			copyArg(msg,"Deployed",params,undefined,false); 
		...
		service.DescribeSuggesters=function(svc,msg,cb){
			...
			copyArg(msg,"DomainName",params,undefined,false); 
			copyArg(msg,"SuggesterNames",params,undefined,true); 
			copyArg(msg,"Deployed",params,undefined,false); 
		...
		service.UpdateAvailabilityOptions=function(svc,msg,cb){
			...
			copyArg(n,"DomainName",params,undefined,false); 
			copyArg(n,"MultiAZ",params,undefined,false); 
		...
		service.UpdateDomainEndpointOptions=function(svc,msg,cb){
			...
			copyArg(n,"DomainName",params,undefined,false); 
			copyArg(n,"DomainEndpointOptions",params,undefined,true); 
		...
		service.UpdateScalingParameters=function(svc,msg,cb){
			...
			copyArg(n,"DomainName",params,undefined,false); 
			copyArg(n,"ScalingParameters",params,undefined,true); 
			
			copyArg(msg,"DomainName",params,undefined,false); 
			copyArg(msg,"ScalingParameters",params,undefined,true); 
		...
		service.UpdateServiceAccessPolicies=function(svc,msg,cb){
			...
			copyArg(n,"DomainName",params,undefined,false); 
			copyArg(n,"AccessPolicies",params,undefined,false); 
