...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.AnalyzeDocument=function(svc,msg,cb){
			...
			copyArg(n,"Document",params,undefined,true); 
			copyArg(n,"FeatureTypes",params,undefined,true); 
			
			copyArg(msg,"Document",params,undefined,true); 
			copyArg(msg,"FeatureTypes",params,undefined,true); 
		...
		service.StartDocumentAnalysis=function(svc,msg,cb){
			...
			copyArg(n,"DocumentLocation",params,undefined,true); 
			copyArg(n,"FeatureTypes",params,undefined,true); 
			
			copyArg(msg,"DocumentLocation",params,undefined,true); 
			copyArg(msg,"FeatureTypes",params,undefined,true); 
