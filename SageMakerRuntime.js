...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.InvokeEndpoint=function(svc,msg,cb){
			...
			copyArg(n,"Body",params,undefined,true); 
			...
			copyArg(msg,"CustomAttributes",params,undefined,true); 
			copyArg(msg,"TargetModel",params,undefined,false); 
			copyArg(msg,"TargetVariant",params,undefined,false); 
			copyArg(msg,"TargetContainerHostname",params,undefined,false); 
			copyArg(msg,"InferenceId",params,undefined,false); 
		...
		service.InvokeEndpointAsync=function(svc,msg,cb){
			...
			copyArg(n,"EndpointName",params,undefined,false); 
			copyArg(n,"InputLocation",params,undefined,false); 
			...
			copyArg(msg,"CustomAttributes",params,undefined,true); 
			copyArg(msg,"InferenceId",params,undefined,false); 
			copyArg(msg,"InputLocation",params,undefined,false); 
			copyArg(msg,"RequestTTLSeconds",params,undefined,false); 
