...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.CreateSuiteDefinition=function(svc,msg,cb){
			...
			copyArg(msg,"suiteDefinitionConfiguration",params,undefined,true); 
		...
		service.DeleteSuiteDefinition=function(svc,msg,cb){
			...
			copyArg(n,"suiteDefinitionId",params,undefined,false); 
			
			copyArg(msg,"suiteDefinitionId",params,undefined,false); 
		...
		service.GetSuiteDefinition=function(svc,msg,cb){
			...
			copyArg(msg,"suiteDefinitionId",params,undefined,false); 
			copyArg(msg,"suiteDefinitionVersion",params,undefined,false); 
		...
		service.GetSuiteRun=function(svc,msg,cb){
			...
			copyArg(n,"suiteDefinitionId",params,undefined,false); 
			copyArg(n,"suiteRunId",params,undefined,false); 
			
			copyArg(msg,"suiteDefinitionId",params,undefined,false); 
			copyArg(msg,"suiteRunId",params,undefined,false); 
		...
		service.StartSuiteRun=function(svc,msg,cb){
			...
			copyArg(msg,"suiteDefinitionId",params,undefined,false); 
			copyArg(msg,"suiteDefinitionVersion",params,undefined,false); 
			copyArg(msg,"suiteRunConfiguration",params,undefined,true); 
			copyArg(msg,"tags",params,undefined,true); 
