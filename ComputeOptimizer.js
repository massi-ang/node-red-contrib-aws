...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.ExportAutoScalingGroupRecommendations=function(svc,msg,cb){
			...
			copyArg(n,"s3DestinationConfig",params,undefined,true); 
			
			copyArg(msg,"accountIds",params,undefined,true); 
			copyArg(msg,"filters",params,undefined,true); 
			copyArg(msg,"fieldsToExport",params,undefined,false); 
			copyArg(msg,"s3DestinationConfig",params,undefined,true); 
			copyArg(msg,"fileFormat",params,undefined,false); 
			copyArg(msg,"includeMemberAccounts",params,undefined,false); 
		...
		service.GetAutoScalingGroupRecommendations=function(svc,msg,cb){
			...
			copyArg(msg,"accountIds",params,undefined,true); 
			copyArg(msg,"autoScalingGroupArns",params,undefined,false); 
			copyArg(msg,"nextToken",params,undefined,false); 
			copyArg(msg,"maxResults",params,undefined,false); 
			copyArg(msg,"filters",params,undefined,true); 
		...
		service.GetEBSVolumeRecommendations=function(svc,msg,cb){
			...
			copyArg(msg,"volumeArns",params,undefined,false); 
			copyArg(msg,"nextToken",params,undefined,false); 
			copyArg(msg,"maxResults",params,undefined,false); 
			copyArg(msg,"filters",params,undefined,true); 
			copyArg(msg,"accountIds",params,undefined,true); 
		...
		service.GetEC2InstanceRecommendations=function(svc,msg,cb){
			...
			copyArg(msg,"instanceArns",params,undefined,false); 
			copyArg(msg,"nextToken",params,undefined,false); 
			copyArg(msg,"maxResults",params,undefined,false); 
			copyArg(msg,"filters",params,undefined,true); 
			copyArg(msg,"accountIds",params,undefined,true); 
		...
		service.GetLambdaFunctionRecommendations=function(svc,msg,cb){
			...
			copyArg(msg,"functionArns",params,undefined,false); 
			copyArg(msg,"accountIds",params,undefined,true); 
			copyArg(msg,"filters",params,undefined,true); 
			copyArg(msg,"nextToken",params,undefined,false); 
			copyArg(msg,"maxResults",params,undefined,false); 
