...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.CreateChangeset=function(svc,msg,cb){
			...
			copyArg(n,"changeType",params,undefined,false); 
			copyArg(n,"sourceType",params,undefined,false); 
			copyArg(n,"sourceParams",params,undefined,true); 
			
			copyArg(msg,"datasetId",params,undefined,false); 
			copyArg(msg,"changeType",params,undefined,false); 
			copyArg(msg,"sourceType",params,undefined,false); 
			copyArg(msg,"sourceParams",params,undefined,true); 
			copyArg(msg,"formatType",params,undefined,false); 
			copyArg(msg,"formatParams",params,undefined,true); 
