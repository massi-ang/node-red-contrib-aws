...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		var awsService = new AWS.ApplicationCostProfiler( { 'region': node.region } );
		
		node.on("input", function(msg) {
			var aService = msg.AWSConfig?new AWS.ApplicationCostProfiler(msg.AWSConfig) : awsService;
		...
		service.ImportApplicationUsage=function(svc,msg,cb){
			...
			copyArg(n,"sourceS3Location",params,undefined,false); 
			
			copyArg(msg,"sourceS3Location",params,undefined,false); 
		...
		service.PutReportDefinition=function(svc,msg,cb){
			...
			copyArg(n,"reportId",params,undefined,false); 
			copyArg(n,"reportDescription",params,undefined,false); 
			copyArg(n,"reportFrequency",params,undefined,false); 
			copyArg(n,"format",params,undefined,false); 
			copyArg(n,"destinationS3Location",params,undefined,true); 
			
			copyArg(msg,"reportId",params,undefined,false); 
			copyArg(msg,"reportDescription",params,undefined,false); 
			copyArg(msg,"reportFrequency",params,undefined,false); 
			copyArg(msg,"format",params,undefined,false); 
			copyArg(msg,"destinationS3Location",params,undefined,true); 
