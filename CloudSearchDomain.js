...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.Search=function(svc,msg,cb){
			...
			copyArg(n,"query",params,undefined,false); 
			
			copyArg(msg,"cursor",params,undefined,false); 
			copyArg(msg,"expr",params,undefined,false); 
			copyArg(msg,"facet",params,undefined,false); 
			copyArg(msg,"filterQuery",params,undefined,false); 
			copyArg(msg,"highlight",params,undefined,false); 
			copyArg(msg,"partial",params,undefined,false); 
			copyArg(msg,"query",params,undefined,false); 
			copyArg(msg,"queryOptions",params,undefined,false); 
			copyArg(msg,"queryParser",params,undefined,false); 
			copyArg(msg,"return",params,undefined,false); 
			copyArg(msg,"size",params,undefined,false); 
			copyArg(msg,"sort",params,undefined,false); 
			copyArg(msg,"start",params,undefined,false); 
			copyArg(msg,"stats",params,undefined,false); 
		...
		service.Suggest=function(svc,msg,cb){
			...
			copyArg(n,"query",params,undefined,false); 
			copyArg(n,"suggester",params,undefined,false); 
			
			copyArg(msg,"query",params,undefined,false); 
			copyArg(msg,"suggester",params,undefined,false); 
			copyArg(msg,"size",params,undefined,false); 
