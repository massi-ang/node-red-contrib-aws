...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		var awsService = new AWS.Macie( { 'region': node.region } );
		
		node.on("input", function(msg) {
			var aService = msg.AWSConfig?new AWS.Macie(msg.AWSConfig) : awsService;
		...
		service.AssociateMemberAccount=function(svc,msg,cb){
			...
			copyArg(n,"memberAccountId",params,undefined,false); 
		...
		service.AssociateS3Resources=function(svc,msg,cb){
			...
			copyArg(n,"s3Resources",params,undefined,true); 
			
			copyArg(msg,"memberAccountId",params,undefined,false); 
			copyArg(msg,"s3Resources",params,undefined,true); 
		...
		service.DisassociateS3Resources=function(svc,msg,cb){
			...
			copyArg(n,"associatedS3Resources",params,undefined,false); 
			
			copyArg(msg,"memberAccountId",params,undefined,false); 
			copyArg(msg,"associatedS3Resources",params,undefined,false); 
		...
		service.UpdateS3Resources=function(svc,msg,cb){
			...
			copyArg(n,"s3ResourcesUpdate",params,undefined,false); 
			
			copyArg(msg,"memberAccountId",params,undefined,false); 
			copyArg(msg,"s3ResourcesUpdate",params,undefined,false); 
