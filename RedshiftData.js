...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.BatchExecuteStatement=function(svc,msg,cb){
			...
			copyArg(n,"Sqls",params,undefined,false); 
			...
			copyArg(msg,"Sqls",params,undefined,false); 
			copyArg(msg,"StatementName",params,undefined,false); 
			copyArg(msg,"WithEvent",params,undefined,false); 
		...
		service.DescribeTable=function(svc,msg,cb){
			...
			copyArg(msg,"ClusterIdentifier",params,undefined,false); 
			copyArg(msg,"ConnectedDatabase",params,undefined,false); 
			copyArg(msg,"Database",params,undefined,false); 
			copyArg(msg,"DbUser",params,undefined,false); 
			...
			copyArg(msg,"SecretArn",params,undefined,false); 
			copyArg(msg,"Table",params,undefined,false); 
		...
		service.ExecuteStatement=function(svc,msg,cb){
			...
			copyArg(n,"ClusterIdentifier",params,undefined,false); 
			copyArg(n,"Database",params,undefined,false); 
			copyArg(n,"Sql",params,undefined,false); 
			...
			copyArg(msg,"SecretArn",params,undefined,false); 
			copyArg(msg,"Sql",params,undefined,false); 
			copyArg(msg,"StatementName",params,undefined,false); 
			copyArg(msg,"WithEvent",params,undefined,false); 
		...
		service.ListSchemas=function(svc,msg,cb){
			...
			copyArg(msg,"MaxResults",params,undefined,false); 
			copyArg(msg,"NextToken",params,undefined,false); 
			copyArg(msg,"SchemaPattern",params,undefined,false); 
			copyArg(msg,"SecretArn",params,undefined,false); 
		...
		service.ListStatements=function(svc,msg,cb){
			...
			copyArg(msg,"MaxResults",params,undefined,false); 
			copyArg(msg,"NextToken",params,undefined,false); 
			copyArg(msg,"RoleLevel",params,undefined,false); 
			copyArg(msg,"StatementName",params,undefined,false); 
		...
		service.ListTables=function(svc,msg,cb){
			...
			copyArg(msg,"SchemaPattern",params,undefined,false); 
			copyArg(msg,"SecretArn",params,undefined,false); 
			copyArg(msg,"TablePattern",params,undefined,false); 
