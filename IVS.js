...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.BatchGetChannel=function(svc,msg,cb){
			...
			copyArg(n,"arns",params,undefined,false); 
		...
		service.CreateChannel=function(svc,msg,cb){
			...
			copyArg(msg,"latencyMode",params,undefined,false); 
			copyArg(msg,"type",params,undefined,false); 
			copyArg(msg,"authorized",params,undefined,false); 
			copyArg(msg,"recordingConfigurationArn",params,undefined,false); 
		...
		service.CreateRecordingConfiguration=function(svc,msg,cb){
			...
			copyArg(n,"destinationConfiguration",params,undefined,true); 
			
			copyArg(msg,"name",params,undefined,false); 
			copyArg(msg,"destinationConfiguration",params,undefined,true); 
			copyArg(msg,"tags",params,undefined,true); 
		...
		service.ListChannels=function(svc,msg,cb){
			...
			copyArg(msg,"filterByName",params,undefined,false); 
			copyArg(msg,"filterByRecordingConfigurationArn",params,undefined,false); 
