...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		var awsService = new AWS.EventBridge( { 'region': node.region } );
		
		node.on("input", function(msg) {
			var aService = msg.AWSConfig?new AWS.EventBridge(msg.AWSConfig) : awsService;
	...
	RED.nodes.registerType("AWS EventBridge", AmazonAPINode);
