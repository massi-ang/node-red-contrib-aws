...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		var awsService = new AWS.Pricing( { 'region': node.region } );
		
		node.on("input", function(msg) {
			var aService = msg.AWSConfig?new AWS.Pricing(msg.AWSConfig) : awsService;
		...
		service.DescribeServices=function(svc,msg,cb){
			...
			copyArg(msg,"FormatVersion",params,undefined,false); 
