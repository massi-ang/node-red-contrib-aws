...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.CreateExperimentTemplate=function(svc,msg,cb){
			...
			copyArg(n,"stopConditions",params,undefined,false); 
			...
			copyArg(msg,"stopConditions",params,undefined,false); 
		...
		service.StartExperiment=function(svc,msg,cb){
			...
			copyArg(n,"clientToken",params,undefined,false); 
			copyArg(n,"experimentTemplateId",params,undefined,false); 
			
			copyArg(msg,"clientToken",params,undefined,false); 
			copyArg(msg,"experimentTemplateId",params,undefined,false); 
			copyArg(msg,"tags",params,undefined,true); 
