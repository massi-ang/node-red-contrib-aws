...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.AcceptDirectConnectGatewayAssociationProposal=function(svc,msg,cb){
			...
			copyArg(n,"directConnectGatewayId",params,undefined,false); 
			copyArg(n,"proposalId",params,undefined,false); 
			copyArg(n,"associatedGatewayOwnerAccount",params,undefined,false); 
			
			copyArg(msg,"directConnectGatewayId",params,undefined,false); 
			copyArg(msg,"proposalId",params,undefined,false); 
			copyArg(msg,"associatedGatewayOwnerAccount",params,undefined,false); 
			copyArg(msg,"overrideAllowedPrefixesToDirectConnectGateway",params,undefined,true); 
		...
		service.AllocateConnectionOnInterconnect=function(svc,msg,cb){
			...
			copyArg(n,"bandwidth",params,undefined,false); 
			copyArg(n,"connectionName",params,undefined,false); 
			copyArg(n,"ownerAccount",params,undefined,false); 
			copyArg(n,"interconnectId",params,undefined,false); 
			copyArg(n,"vlan",params,undefined,false); 
			
			copyArg(msg,"bandwidth",params,undefined,false); 
			copyArg(msg,"connectionName",params,undefined,false); 
			copyArg(msg,"ownerAccount",params,undefined,false); 
			copyArg(msg,"interconnectId",params,undefined,false); 
			copyArg(msg,"vlan",params,undefined,false); 
		...
		service.AllocatePrivateVirtualInterface=function(svc,msg,cb){
			...
			copyArg(n,"connectionId",params,undefined,false); 
			copyArg(n,"ownerAccount",params,undefined,false); 
			copyArg(n,"newPrivateVirtualInterfaceAllocation",params,undefined,false); 
			
			copyArg(msg,"connectionId",params,undefined,false); 
			copyArg(msg,"ownerAccount",params,undefined,false); 
			copyArg(msg,"newPrivateVirtualInterfaceAllocation",params,undefined,false); 
		...
		service.AllocatePublicVirtualInterface=function(svc,msg,cb){
			...
			copyArg(n,"connectionId",params,undefined,false); 
			copyArg(n,"ownerAccount",params,undefined,false); 
			copyArg(n,"newPublicVirtualInterfaceAllocation",params,undefined,false); 
			
			copyArg(msg,"connectionId",params,undefined,false); 
			copyArg(msg,"ownerAccount",params,undefined,false); 
			copyArg(msg,"newPublicVirtualInterfaceAllocation",params,undefined,false); 
		...
		service.AllocateTransitVirtualInterface=function(svc,msg,cb){
			...
			copyArg(n,"connectionId",params,undefined,false); 
			copyArg(n,"ownerAccount",params,undefined,false); 
			copyArg(n,"newTransitVirtualInterfaceAllocation",params,undefined,false); 
			
			copyArg(msg,"connectionId",params,undefined,false); 
			copyArg(msg,"ownerAccount",params,undefined,false); 
			copyArg(msg,"newTransitVirtualInterfaceAllocation",params,undefined,false); 
		...
		service.AssociateConnectionWithLag=function(svc,msg,cb){
			...
			copyArg(n,"connectionId",params,undefined,false); 
			copyArg(n,"lagId",params,undefined,false); 
			
			copyArg(msg,"connectionId",params,undefined,false); 
			copyArg(msg,"lagId",params,undefined,false); 
		...
		service.AssociateHostedConnection=function(svc,msg,cb){
			...
			copyArg(n,"connectionId",params,undefined,false); 
			copyArg(n,"parentConnectionId",params,undefined,false); 
			
			copyArg(msg,"connectionId",params,undefined,false); 
			copyArg(msg,"parentConnectionId",params,undefined,false); 
		...
		service.AssociateMacSecKey=function(svc,msg,cb){
			...
			copyArg(msg,"connectionId",params,undefined,false); 
			copyArg(msg,"secretARN",params,undefined,false); 
			copyArg(msg,"ckn",params,undefined,false); 
			copyArg(msg,"cak",params,undefined,false); 
		...
		service.AssociateVirtualInterface=function(svc,msg,cb){
			...
			copyArg(n,"virtualInterfaceId",params,undefined,false); 
			copyArg(n,"connectionId",params,undefined,false); 
			
			copyArg(msg,"virtualInterfaceId",params,undefined,false); 
			copyArg(msg,"connectionId",params,undefined,false); 
		...
		service.ConfirmPrivateVirtualInterface=function(svc,msg,cb){
			...
			copyArg(msg,"virtualInterfaceId",params,undefined,false); 
			copyArg(msg,"virtualGatewayId",params,undefined,false); 
			copyArg(msg,"directConnectGatewayId",params,undefined,false); 
		...
		service.CreateBGPPeer=function(svc,msg,cb){
			...
			copyArg(msg,"virtualInterfaceId",params,undefined,false); 
			copyArg(msg,"newBGPPeer",params,undefined,false); 
		...
		service.CreateConnection=function(svc,msg,cb){
			...
			copyArg(msg,"requestMACSec",params,undefined,false); 
		...
		service.CreateDirectConnectGateway=function(svc,msg,cb){
			...
			copyArg(n,"directConnectGatewayName",params,undefined,false); 
			
			copyArg(msg,"directConnectGatewayName",params,undefined,false); 
		...
		service.CreateDirectConnectGatewayAssociation=function(svc,msg,cb){
			...
			copyArg(msg,"addAllowedPrefixesToDirectConnectGateway",params,undefined,true); 
			copyArg(msg,"virtualGatewayId",params,undefined,false); 
		...
		service.CreateDirectConnectGatewayAssociationProposal=function(svc,msg,cb){
			...
			copyArg(n,"directConnectGatewayId",params,undefined,false); 
			copyArg(n,"directConnectGatewayOwnerAccount",params,undefined,false); 
			copyArg(n,"gatewayId",params,undefined,false); 
			
			copyArg(msg,"directConnectGatewayId",params,undefined,false); 
			copyArg(msg,"directConnectGatewayOwnerAccount",params,undefined,false); 
			copyArg(msg,"gatewayId",params,undefined,false); 
			copyArg(msg,"addAllowedPrefixesToDirectConnectGateway",params,undefined,true); 
			copyArg(msg,"removeAllowedPrefixesToDirectConnectGateway",params,undefined,true); 
		...
		service.CreateInterconnect=function(svc,msg,cb){
			...
			copyArg(n,"interconnectName",params,undefined,false); 
			copyArg(n,"bandwidth",params,undefined,false); 
			copyArg(n,"location",params,undefined,false); 
			
			copyArg(msg,"interconnectName",params,undefined,false); 
			copyArg(msg,"bandwidth",params,undefined,false); 
			copyArg(msg,"location",params,undefined,false); 
			copyArg(msg,"lagId",params,undefined,false); 
			copyArg(msg,"tags",params,undefined,true); 
		...
		service.CreateLag=function(svc,msg,cb){
			...
			copyArg(n,"numberOfConnections",params,undefined,false); 
			copyArg(n,"location",params,undefined,false); 
			copyArg(n,"connectionsBandwidth",params,undefined,false); 
			copyArg(n,"lagName",params,undefined,false); 
			
			copyArg(msg,"numberOfConnections",params,undefined,false); 
			copyArg(msg,"location",params,undefined,false); 
			copyArg(msg,"connectionsBandwidth",params,undefined,false); 
			copyArg(msg,"lagName",params,undefined,false); 
			copyArg(msg,"connectionId",params,undefined,false); 
			copyArg(msg,"tags",params,undefined,true); 
			copyArg(msg,"childConnectionTags",params,undefined,true); 
			copyArg(msg,"providerName",params,undefined,false); 
			copyArg(msg,"requestMACSec",params,undefined,false); 
		...
		service.CreatePrivateVirtualInterface=function(svc,msg,cb){
			...
			copyArg(n,"connectionId",params,undefined,false); 
			copyArg(n,"newPrivateVirtualInterface",params,undefined,false); 
			
			copyArg(msg,"connectionId",params,undefined,false); 
			copyArg(msg,"newPrivateVirtualInterface",params,undefined,false); 
		...
		service.CreatePublicVirtualInterface=function(svc,msg,cb){
			...
			copyArg(n,"connectionId",params,undefined,false); 
			copyArg(n,"newPublicVirtualInterface",params,undefined,false); 
			
			copyArg(msg,"connectionId",params,undefined,false); 
			copyArg(msg,"newPublicVirtualInterface",params,undefined,false); 
		...
		service.CreateTransitVirtualInterface=function(svc,msg,cb){
			...
			copyArg(n,"connectionId",params,undefined,false); 
			copyArg(n,"newTransitVirtualInterface",params,undefined,false); 
			
			copyArg(msg,"connectionId",params,undefined,false); 
			copyArg(msg,"newTransitVirtualInterface",params,undefined,false); 
		...
		service.DeleteBGPPeer=function(svc,msg,cb){
			...
			copyArg(msg,"virtualInterfaceId",params,undefined,false); 
			copyArg(msg,"asn",params,undefined,false); 
			copyArg(msg,"customerAddress",params,undefined,false); 
			copyArg(msg,"bgpPeerId",params,undefined,false); 
		...
		service.DescribeConnectionLoa=function(svc,msg,cb){
			...
			copyArg(msg,"connectionId",params,undefined,false); 
			copyArg(msg,"providerName",params,undefined,false); 
			copyArg(msg,"loaContentType",params,undefined,false); 
		...
		service.DescribeDirectConnectGatewayAssociationProposals=function(svc,msg,cb){
			...
			copyArg(msg,"directConnectGatewayId",params,undefined,false); 
			copyArg(msg,"proposalId",params,undefined,false); 
			copyArg(msg,"associatedGatewayId",params,undefined,false); 
		...
		service.DescribeTags=function(svc,msg,cb){
			...
			copyArg(n,"resourceArns",params,undefined,false); 
		...
		service.DisassociateMacSecKey=function(svc,msg,cb){
			...
			copyArg(n,"connectionId",params,undefined,false); 
			copyArg(n,"secretARN",params,undefined,false); 
		...
		service.ListVirtualInterfaceTestHistory=function(svc,msg,cb){
			...
			copyArg(msg,"testId",params,undefined,false); 
			copyArg(msg,"virtualInterfaceId",params,undefined,false); 
			copyArg(msg,"bgpPeers",params,undefined,true); 
		...
		service.StartBgpFailoverTest=function(svc,msg,cb){
			...
			copyArg(msg,"virtualInterfaceId",params,undefined,false); 
			copyArg(msg,"bgpPeers",params,undefined,true); 
			copyArg(msg,"testDurationInMinutes",params,undefined,false); 
		...
		service.UpdateLag=function(svc,msg,cb){
			...
			copyArg(msg,"lagId",params,undefined,false); 
			copyArg(msg,"lagName",params,undefined,false); 
			copyArg(msg,"minimumLinks",params,undefined,false); 
			copyArg(msg,"encryptionMode",params,undefined,false); 
		...
		service.UpdateVirtualInterfaceAttributes=function(svc,msg,cb){
			...
			copyArg(msg,"virtualInterfaceId",params,undefined,false); 
			copyArg(msg,"mtu",params,undefined,false); 
