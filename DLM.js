...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.GetLifecyclePolicies=function(svc,msg,cb){
			...
			copyArg(msg,"PolicyIds",params,undefined,false); 
			copyArg(msg,"State",params,undefined,false); 
			copyArg(msg,"ResourceTypes",params,undefined,true); 
			copyArg(msg,"TargetTags",params,undefined,false); 
			copyArg(msg,"TagsToAdd",params,undefined,false); 
