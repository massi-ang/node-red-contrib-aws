...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.BatchMeterUsage=function(svc,msg,cb){
			...
			copyArg(n,"UsageRecords",params,undefined,true); 
			copyArg(n,"ProductCode",params,undefined,false); 
			
			copyArg(msg,"UsageRecords",params,undefined,true); 
		...
		service.MeterUsage=function(svc,msg,cb){
			...
			copyArg(n,"ProductCode",params,undefined,false); 
			copyArg(n,"Timestamp",params,undefined,false); 
			copyArg(n,"UsageDimension",params,undefined,false); 
			
			copyArg(msg,"ProductCode",params,undefined,false); 
			copyArg(msg,"Timestamp",params,undefined,false); 
			copyArg(msg,"UsageDimension",params,undefined,false); 
			copyArg(msg,"UsageQuantity",params,undefined,false); 
			copyArg(msg,"DryRun",params,undefined,false); 
			copyArg(msg,"UsageAllocations",params,undefined,true); 
		...
		service.RegisterUsage=function(svc,msg,cb){
			...
			copyArg(n,"ProductCode",params,undefined,false); 
			copyArg(n,"PublicKeyVersion",params,undefined,false); 
			
			copyArg(msg,"ProductCode",params,undefined,false); 
			copyArg(msg,"PublicKeyVersion",params,undefined,false); 
