...
module.exports = function(RED) {
	...
	function AmazonAPINode(n) {
		...
		service.CompleteAttachmentUpload=function(svc,msg,cb){
			...
			copyArg(n,"AttachmentIds",params,undefined,false); 
			copyArg(n,"ClientToken",params,undefined,false); 
			copyArg(n,"ConnectionToken",params,undefined,false); 
			
			copyArg(msg,"AttachmentIds",params,undefined,false); 
			copyArg(msg,"ClientToken",params,undefined,false); 
			copyArg(msg,"ConnectionToken",params,undefined,false); 
		...
		service.CreateParticipantConnection=function(svc,msg,cb){
			...
			copyArg(n,"ParticipantToken",params,undefined,false); 
			
			copyArg(msg,"Type",params,undefined,false); 
			copyArg(msg,"ParticipantToken",params,undefined,false); 
		...
		service.GetTranscript=function(svc,msg,cb){
			...
			copyArg(msg,"ScanDirection",params,undefined,false); 
			copyArg(msg,"SortOrder",params,undefined,false); 
			copyArg(msg,"StartPosition",params,undefined,false); 
			copyArg(msg,"ConnectionToken",params,undefined,false); 
		...
		service.StartAttachmentUpload=function(svc,msg,cb){
			...
			copyArg(n,"ContentType",params,undefined,false); 
			copyArg(n,"AttachmentSizeInBytes",params,undefined,false); 
			copyArg(n,"AttachmentName",params,undefined,false); 
			copyArg(n,"ClientToken",params,undefined,false); 
			copyArg(n,"ConnectionToken",params,undefined,false); 
			
			copyArg(msg,"ContentType",params,undefined,false); 
			copyArg(msg,"AttachmentSizeInBytes",params,undefined,false); 
			copyArg(msg,"AttachmentName",params,undefined,false); 
			copyArg(msg,"ClientToken",params,undefined,false); 
			copyArg(msg,"ConnectionToken",params,undefined,false); 
